...
import { navigate, onBack, toggleDrawer } from '../../navigation/RootNavigation';
		...
		<View
			...
			<View style={styles.headerContent}>
				<View style={{ flex: 1, justifyContent: 'center', alignItems: 'flex-start' }}>
					{backBtn && (
						<TouchableOpacity style={styles.leftSideStyle} onPress={() => props.onBackPress ? props.onBackPress() : onBack()}>
							<FaIcon name="arrow-left" color='#fff' size={16} />
						</TouchableOpacity>
					)}
					{drawerBtn && (
						<TouchableOpacity style={styles.leftSideStyle} onPress={() => toggleDrawer() }>
